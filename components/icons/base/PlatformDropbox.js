...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      a11yTitle = a11yTitle || _react2.default.createElement(_FormattedMessage2.default, { id: 'platform-dropbox', defaultMessage: 'platform-dropbox' });

      return _react2.default.createElement(
        'svg',
        { version: '1.1', viewBox: '0 0 24.003 24', width: '24px', height: '24px', role: 'img', className: classes, 'aria-labelledby': a11yTitleId },
