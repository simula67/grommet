...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      a11yTitle = a11yTitle || _react2.default.createElement(_FormattedMessage2.default, { id: 'schedule-clone', defaultMessage: 'schedule-clone' });

      return _react2.default.createElement(
        'svg',
        { version: '1.1', viewBox: '0 0 24.0004 25', width: '24px', height: '24px', role: 'img', className: classes, 'aria-labelledby': a11yTitleId },
        ...
        _react2.default.createElement(
          'g',
          { id: 'schedule-clone' },
          _react2.default.createElement('rect', { id: '_x2E_svg_212_', x: '0', y: '0', fill: 'none', width: '24', height: '24' }),
