...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      a11yTitle = a11yTitle || _react2.default.createElement(_FormattedMessage2.default, { id: 'folder-open', defaultMessage: 'folder-open' });

      return _react2.default.createElement(
        'svg',
        { version: '1.1', viewBox: '0 0 24.5616 24', width: '24px', height: '24px', role: 'img', className: classes, 'aria-labelledby': a11yTitleId },
        ...
        _react2.default.createElement(
          'g',
          { id: 'folder-open' },
          _react2.default.createElement('rect', { id: '_x2E_svg_42_', x: '0.2808', y: '0', fill: 'none', width: '24', height: '24' }),
