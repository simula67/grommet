...
var Icon = function (_Component) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      a11yTitle = a11yTitle || _react2.default.createElement(_FormattedMessage2.default, { id: 'user-new', defaultMessage: 'user-new' });

      return _react2.default.createElement(
        'svg',
        { version: '1.1', viewBox: '0 0 25.6963 24', width: '24px', height: '24px', role: 'img', className: classes, 'aria-labelledby': a11yTitleId },
        ...
        _react2.default.createElement(
          'g',
          { id: 'user-new' },
          _react2.default.createElement('rect', { id: '_x2E_svg_131_', x: '0.0312', fill: 'none', width: '24', height: '24' }),
